          ...
          <div className="shadow p-4 mt-4">
              ...
              <form onSubmit={handleSubmit} id="create-record-of-sale-form">
                  <div className="form-floating mb-3">
                      <select required value={automobile} onChange={handleAutomobileChange} placeholder="VIN" type="text" name="automobile" id="automobile" className="form-control">
                  ...
                  <div className="form-floating mb-3">
                      <input value={price} onChange={handlePriceChange} placeholder="Price" type="number" name="employee_id" id="price" className="form-control" />
                      <label>Price</label>
                  </div>
